...
{
    public GameObject BulletPrehab;     // íeñãÇÃÉvÉåÉnÉu
    public int bulletNum;               // íeñãÇÃêî
    public float speed;                 // íeñãÇÃÉXÉsÅ[Éh
    public float delayTime;             // íeñãÇÃèoÇ∑ä‘äu
    public float angleOffset;           // íeñãÇÃäpìxÇÇ∏ÇÁÇ∑ÇΩÇﬂÇÃïœêî
}
